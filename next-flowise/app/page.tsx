    ...
    <div className="container mx-auto p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-blue-700">
          Flowise Source Document Explorer
        </h1>

        <p className="mb-8 text-gray-600 text-lg">
          This application helps you extract and view source documents from
          Flowise API responses. It provides several different tools to handle
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              ...
              approach. Works with all known Flowise API response formats and
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              ...
              documents from Flowise API responses, handling various response
